...
describe Application do
    describe "#run!" do
        ...
        context "input1" do
            let(:input_file) { '../data/input1.csv' }
            let(:output_file) { '../data/output1.csv' }

            it { expect{ subject }.to output(expected_output).to_stdout }
        end

        context "input2" do
            let(:input_file) { '../data/input2.csv' }
            let(:output_file) { '../data/output2.csv' }

            it { expect{ subject }.to output(expected_output).to_stdout }
        end

        context "input3" do
            let(:input_file) { '../data/input3.csv' }
            let(:output_file) { '../data/output3.csv' }
